#ifndef __MEMORY_USAGE_INFO_H__
#define __MEMORY_USAGE_INFO_H__

#include "CommonViewImpl.h"
class CMemoryUsageInfoView : public CCommonViewImpl
{
public:
	explicit CMemoryUsageInfoView(wxWindow* _parent, const wxSize& _size);
	virtual ~CMemoryUsageInfoView();

	virtual void UpdateData(unsigned long _val = 0) wxOVERRIDE;
	void UpdateData(unsigned long long ullAvaliable, unsigned long long ullPhysical);
